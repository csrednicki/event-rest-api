...
module.exports = {
    ...
    async get(sql, sqlParams, cb, response) {
        try {
    ...
    async delete(sql, sqlParams, response) {
        try {
    ...
    async create(sql, sqlParams, cb, response) {
        try {
            const results = await db.pool.query(sql, sqlParams);
            if(results.rows.length > 0) {
    ...
    async put(sql, sqlParams, cb, response) {
        try {
